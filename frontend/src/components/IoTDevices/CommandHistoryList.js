...
function CommandHistoryList({ commands }) {
  ...
  const columns = useMemo(
    () => [
      { Header: "Command ID", accessor: "command_id", width: "15%", align: "left" },
      { Header: "Type", accessor: "type", width: "15%", align: "left" },
      { Header: "Priority", accessor: "priority", width: "10%", align: "center" },
      { Header: "Status", accessor: "status", width: "10%", align: "center" },
      { Header: "Sent At", accessor: "sent_at", width: "20%", align: "left" },
      { Header: "Completed At", accessor: "completed_at", width: "20%", align: "left" },
    ],
    []
  );
