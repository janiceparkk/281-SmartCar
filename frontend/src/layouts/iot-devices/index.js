      ...
      <MDBox pt={6} pb={3}>
        <Grid container spacing={3}>
          <Grid item xs={12} md={6} lg={3}>
            <MDBox mb={1.5} sx={{ transition: "all 0.3s ease-in-out" }}>
                ...
                <MDBox p={3}>
                  <Grid container spacing={2} mb={3}>
                    ...
                    <Grid item xs={12} md={3} display="flex" gap={1}>
                      <Button variant="contained" color="info" fullWidth onClick={handleApplyFilters}>
                        Apply
                      </Button>
                      <Button variant="outlined" color="info" fullWidth onClick={handleClearFilters}>
                        Clear
                      </Button>
                    </Grid>
                  </Grid>
