...
function DeviceDetails() {
  ...
  }, [deviceId, fetchDeviceDetails, fetchDeviceStatus, fetchDeviceDiagnostics]);
    ...
    return (
      <DashboardLayout>
        ...
        <MDBox pt={6} pb={3}>
          ...
          <Button variant="contained" color="info" onClick={handleBackToDashboard}>
            Back to Dashboard
          </Button>
        </MDBox>
        <Footer />
              ...
              <MDBox p={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    {device.last_firmware_update && (
                      <MDBox mb={2}>
                        ...
                        <MDTypography variant="body2" color="text">
                          {formatDate(device.last_firmware_update)}
                        </MDTypography>
                      </MDBox>
                    )}
                  </Grid>
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12} md={6}>
                        <MDBox mb={2}>
                          ...
                          <MDBox mt={0.5}>
                            <DeviceStatusBadge status={deviceStatus.status} />
                          </MDBox>
                        </MDBox>
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <MDBox mb={2}>
                          ...
                          <MDTypography variant="body2" color="text">
                            {formatDate(deviceStatus.last_heartbeat)}
                          </MDTypography>
                        </MDBox>
                      </Grid>
                    </Grid>
                ...
                {diagnostics && diagnostics.health_metrics && (
                  <>
                    ...
                    <Grid container spacing={2}>
                      {diagnostics.health_metrics.battery_level !== null && (
                        <Grid item xs={12} md={4}>
                          <MDBox mb={2}>
                            ...
                            <MDTypography variant="body2" color="text">
                              {diagnostics.health_metrics.battery_level}%
                            </MDTypography>
                          </MDBox>
                        </Grid>
                      )}
                      {diagnostics.health_metrics.signal_strength !== null && (
                        <Grid item xs={12} md={4}>
                          <MDBox mb={2}>
                            <MDTypography variant="caption" color="text" fontWeight="bold">
                              Signal Strength:
                            ...
                            <MDTypography variant="body2" color="text">
                              {diagnostics.health_metrics.signal_strength} dBm
                            </MDTypography>
                          </MDBox>
                        </Grid>
                      )}
                      {diagnostics.health_metrics.temperature !== null && (
                        <Grid item xs={12} md={4}>
                          <MDBox mb={2}>
                            <MDTypography variant="caption" color="text" fontWeight="bold">
                              Temperature:
                            ...
                            <MDTypography variant="body2" color="text">
                              {diagnostics.health_metrics.temperature}°C
                            </MDTypography>
                          </MDBox>
                        </Grid>
                      )}
